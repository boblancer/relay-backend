...
class BlobStorage(Protocol):
    def save(self, namespace_id: int, record_id: int, filename: str, data: bytes) -> str: ...
    def read(self, namespace_id: int, record_id: int, filename: str) -> bytes: ...
    def delete(self, namespace_id: int, record_id: int, filename: str) -> None: ...
