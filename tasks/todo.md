...
- [ ] Task 1: Approve the namespace contract and compatibility window.
...
- [ ] Task 2: Specify the public contract and namespace models with failing tests.
...
- [ ] Task 3: Add and verify migration `0004`.
...
- [ ] Task 4: Implement namespace metadata persistence and global idempotency reuse.
...
- [ ] Task 5: Make workflow persistence namespace-aware.
...
- [ ] Task 6: Add namespace and nested workflow controllers through shared services.
...
- [ ] Task 7: Record the architecture and rollout.
...
- [ ] Task 8: Complete privacy, concurrency, compatibility, and migration review.
